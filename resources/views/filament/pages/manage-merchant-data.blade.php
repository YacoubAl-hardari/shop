<x-filament-panels::page>
    <x-filament::section>
        ...
        <x-slot name="description">
            يمكنك تصدير جميع بيانات الفرع التجارية بصيغتين مختلفتين حسب احتياجك.
        </x-slot>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-900/50">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    استخدم هذا الخيار إذا كنت تريد حفظ نسخة احتياطية كاملة لاسترجاع بيانات الفرع مستقبلاً.
                </p>
    ...
    <x-filament::section class="mt-6">
        ...
        <x-slot name="description">
            قم برفع ملف JSON الذي قمت بتصديره مسبقاً لاسترجاع جميع بيانات الفرع. سيتم استبدال البيانات الحالية بالكامل.
        </x-slot>
    ...
    <x-filament::section collapsible collapsed class="mt-6">
        <x-slot name="heading">
            حذف بيانات الفرع نهائياً
        </x-slot>

        <x-slot name="description">
            حذف جميع البيانات التجارية المرتبطة بالفرع الحالي بشكل نهائي. هذا الإجراء لا يمكن التراجع عنه.
        </x-slot>
        ...
        <div class="space-y-4">
            <div class="bg-red-50 dark:bg-red-950/50 border border-red-200 dark:border-red-900 rounded-lg p-4">
                ...
                <p class="text-sm text-red-800 dark:text-red-200 mb-3">
                    عند حذف بيانات الفرع، سيتم حذف جميع البيانات التالية بشكل نهائي:
                </p>
                <ul class="space-y-1 text-sm text-red-800 dark:text-red-200">
                    <li>• الموردون والموزعون</li>
                    <li>• المنتجات والمخزون</li>
                    <li>• العملاء ومبيعات نقطة البيع</li>
                    <li>• شجرة الحسابات والقيود اليومية</li>
                    <li>• وسائل الدفع وسدادات العملاء</li>
                </ul>
            </div>
            ...
            <form wire:submit.prevent="deleteDataAction" class="space-y-4">
                <div>
    ...
    <x-filament::section class="mt-6">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">بيانات الفرع</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">معلومات الفرع والإعدادات</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">المشتريات</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">الموردون والموزعون</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">المخزون والمنتجات</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">كافة بيانات المنتجات والمخزون</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">المبيعات ونقطة البيع</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">الفواتير وتفاصيل المبيعات</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">العملاء والسدادات</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">المديونية والرصيد الفائض والتحصيلات</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">المحاسبة</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">شجرة الحسابات والقيود اليومية</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900 dark:text-white">وسائل الدفع</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">البنوك والبطاقات والمحافظ</p>
                </div>
            </div>
        </div>
    </x-filament::section>
